...
export function TileFrame({
  ...
  // Solid surface, not a translucent wash: the charts separate marks with
  // 2px gaps/rings painted in --tile-surface, which must match this bg exactly.
  return (
    <div className="flex flex-col rounded-xl border border-black/10 bg-[var(--tile-surface)] p-4 shadow-sm dark:border-white/15">
      {title && (
